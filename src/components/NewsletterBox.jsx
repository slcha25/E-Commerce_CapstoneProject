  ...
  return (
    <div className='text-center'>
        ...
        <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-center gap-3'>
            <input type="email" placeholder='Enter your email' className='border border-gray-300 rounded-md p-2 w-64 sm:w-80 focus:outline-none focus:ring-2 focus:ring-blue-500' required/>
